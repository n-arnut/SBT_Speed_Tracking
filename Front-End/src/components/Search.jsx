...
export default function Search({
  ...
  return (
    < div className='flex items-center justify-center'>
      ...
      {showLoading ?<div className='grid justify-items-center mt-10'>
          <svg aria-hidden="true" className="w-8 h-8 text-gray-200 animate-spin fill-red-600" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <span className="mt-3 font-semibold">Loading...</span>
      </div> : null}

      {showLoading ? null: <div>
